...
#define SURFACE_IS_DEATH_PLANE(cmd)   (cmd == SURFACE_DEATH_PLANE || cmd == SURFACE_VERTICAL_WIND)
#define SURFACE_IS_LETHAL(cmd)        (cmd == SURFACE_DEATH_PLANE || cmd == SURFACE_VERTICAL_WIND || cmd == SURFACE_BURNING)
