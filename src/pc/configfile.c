...
// control binds
#ifdef TOUCH_CONTROLS
static const unsigned int defaultConfigKeyA[MAX_BINDS]          = { 0x0026,     0x1000,     VK_INVALID };
static const unsigned int defaultConfigKeyB[MAX_BINDS]          = { 0x0033,     0x1001,     VK_INVALID };
#else
...
#ifdef TOUCH_CONTROLS
static const unsigned int defaultConfigKeyL[MAX_BINDS]          = { 0x002A,     0x1009,     VK_INVALID };
static const unsigned int defaultConfigKeyR[MAX_BINDS]          = { 0x0036,     0x100A,     VK_INVALID };
static const unsigned int defaultConfigKeyZ[MAX_BINDS]          = { 0x0025,     0x101A,     VK_INVALID };
#else
