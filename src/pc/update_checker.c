...
#define URL "https://raw.githubusercontent.com/Froggy-TL/Super-Mario-64-OMM-Coop/refs/heads/main/src/pc/network/version.h"
...
void get_version_remote(void) {
    ...
    // initialize WinINet
    HINTERNET hInternet = InternetOpenA("Super Mario 64 OMM-Coop", INTERNET_OPEN_TYPE_DIRECT, NULL, NULL, 0);
    if (!hInternet) {
