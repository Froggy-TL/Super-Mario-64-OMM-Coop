...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/include $(LOCAL_PATH)/include/android_execinfo $(LOCAL_PATH)/src $(LOCAL_PATH)/sound $(LOCAL_PATH)/lib/lua/include $(LOCAL_PATH)/lib/coopnet/include $(LOCAL_PATH)/lib/sdl2/include $(LOCAL_PATH)/lib/curl/include $(PC_BUILD_DIR) $(PC_BUILD_DIR)/include $(JNI_H_INCLUDE) $(LOCAL_PATH)/data/omm/engine/headers $(LOCAL_PATH)/data/omm/engine/headers/actors $(LOCAL_PATH)/data/omm/engine/headers/include $(LOCAL_PATH)/data/omm/engine/headers/include/PR $(LOCAL_PATH)/data/omm/engine/headers/src $(LOCAL_PATH)/data/omm/engine/headers/src/engine $(LOCAL_PATH)/data/omm/engine/headers/src/extras $(LOCAL_PATH)/data/omm/engine/headers/src/game $(LOCAL_PATH)/data/omm/engine/headers/src/menu $(LOCAL_PATH)/data/omm/engine/headers/src/pc
