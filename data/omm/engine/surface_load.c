...
u32 omm_get_area_terrain_size(s16 *data) {
...
void omm_load_area_terrain(s16 areaIndex, s16 *data, s8 *surfaceRooms, s16 *macroObjects) {
...
void omm_clear_dynamic_surfaces() {
...
void omm_load_object_collision_model() {
