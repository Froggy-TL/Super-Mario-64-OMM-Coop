...
void omm_bhv_heave_ho_throw_mario_loop(void) {
    obj_mark_for_deletion(o);
}

void omm_heave_ho_act_0(void) {
    cur_obj_set_pos_to_home();
    o->oAction = 1;
}

void omm_heave_ho_act_1(void) {
    o->oForwardVel = 0.f;
...
void (*sHeaveHoActions[])(void) = { omm_heave_ho_act_0, omm_heave_ho_act_1, omm_heave_ho_act_2, omm_heave_ho_act_3 };

void omm_heave_ho_move(void) {
...
void omm_bhv_heave_ho_loop(void) {
    cur_obj_scale(2.f);
    switch (o->oHeldState) {
        case HELD_FREE: omm_heave_ho_move(); break;
